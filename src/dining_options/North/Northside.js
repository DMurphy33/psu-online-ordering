...
class Northside extends Component {
    constructor(props) {
        super(props);
        this.state = {
            selectedFood: [],
        ...
        return(
            <div>
                ...
                <ListGroup>
                    ...
                    <ListGroupItem>
                        <span>
                            Quinoa Falafel with Tomato Cucumber Salad
                        </span>
                        <FontAwesomeIcon 
                            onClick={() => this.handleSelection('Quinoa Falafel with Tomato Cucumber Salad')} 
                            className='add-item-plus' 
                            icon={faPlusCircle} 
                        />
                    </ListGroupItem>
                    <ListGroupItem>
                        <span>
                            Silken Cucubmer Sauce
                        </span>
                        <FontAwesomeIcon 
                            onClick={() => this.handleSelection('Silken Cucubmer Sauce')} 
                            className='add-item-plus' 
                            icon={faPlusCircle} 
                        />
                    </ListGroupItem>
